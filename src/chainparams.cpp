...
{
    const char* pszTimestamp = "Shiba asked his mother - mom where I was born - from here (pointing down) on 28/03/2022";
...
public:
    CMainParams() {
        ...
        consensus.nProtocolV1RetargetingFixedTime = 1648457245;
        consensus.nProtocolV2Time = 1648457246;
        consensus.nProtocolV3Time = 1648457245;
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed.coinshiba.xyz", "vps.coinshiba.xyz"));
        vSeeds.push_back(CDNSSeedData("51.195.249.132", "51.195.249.132"));
	vSeeds.push_back(CDNSSeedData("135.125.225.55", "135.125.225.55"));
	vSeeds.push_back(CDNSSeedData("188.165.255.50", "188.165.255.50"));
        ...
        checkpointData = (CCheckpointData) {
                    ...
                    (0, uint256S("0x0000066a55d5635a0407b14644535ba3764338ccf066766a56300686291b3364"))
                    (1, uint256S("e8263d973e6133d29d3594a621ed02ed9d4e9798b10e5dbc19e84a8e2fbf4240"))
                    (10, uint256S("ea989562a0b6d575cdf2c8282eeed077406a600963060bcd9fc2c69b860859d0"))
                    (100, uint256S("e6a8b3c0d147ca3f18acb26af73db7331d728e8f2e1c9230e24dff10f482976c"))
                    (110, uint256S("254b566dca6bcd5830063378de76af77560a06493b71e7caaab81f0648e2f0cb"))
                    (160, uint256S("45f99de2639f0b497d94723b40fb41024635a33f02f86dd710d78d6e1f6f6b17"))
                    (240, uint256S("c9cdef96257504e5e1657266c04469270055c62f1d1ad96c49fcf0d83202100f")),		
				
                    1648557398, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000b51d3cb7060cb2b3cb1d1899da0ca35f8e1491d6e06d563bc39a3d75da8"));
        assert(genesis.hashMerkleRoot == uint256S("0x09550f72ac54e94345326c0f39a27756940e87592290190170eafd998df65784"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000b51d3cb7060cb2b3cb1d1899da0ca35f8e1491d6e06d563bc39a3d75da8")),
            1639925421,
            0,
            0
        };
