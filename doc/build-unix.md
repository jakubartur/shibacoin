UNIX BUILD NOTES
====================
Some notes on how to build shibacoin in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile shibacoin and the dependencies,
...
This will build shibacoin-qt as well if the dependencies are met.
...
memory available when compiling shibacoin. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build shibacoin without wallet.
...
If you want to build shibacoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a shibacoin-qt executable will be
built by default.
...
# Configure shibacoin to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://gitlab.com/shibacoin/shibacoin.git
    cd shibacoin/
    ./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard shibacoin distributions and independently built
